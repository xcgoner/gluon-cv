...
def get_dataloader(net, train_dataset, val_dataset, data_shape, global_batch_size, num_workers, ctx):
    """Get dataloader."""
...
def get_dali_dataloader(net, train_dataset, val_dataset, data_shape, global_batch_size, num_workers, devices, ctx):
    width, height = data_shape, data_shape
    with autograd.train_mode():
...
def train(net, train_data, val_data, eval_metric, ctx, args):
    ...
    # TODO: specifiy filename by hyperparameters
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        for i, batch in enumerate(train_data):
            ...
            if hvd.rank() == 0:
                local_batch_size = int(args.batch_size // hvd.size())
...
if __name__ == '__main__':
    ...
    if args.dali:
        ...
        train_data, val_data = get_dataloader(
            async_net, train_dataset, val_dataset, args.data_shape, args.batch_size, args.num_workers, ctx[0])
