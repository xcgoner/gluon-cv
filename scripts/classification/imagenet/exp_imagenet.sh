...
do
    ...
    --model resnet50_v2 --mode hybrid   --lr 0.1 --lr-mode cosine --num-epochs 120 --batch-size 32 -j 6   \
    --warmup-epochs 5 --use-rec --dtype float16 --optimizer nag \
    --trainer qsparselocalsgd --input-sparse-1 1 --output-sparse-1 4 --layer-sparse-1 32 --local-sgd-interval 2
    ...
    --model resnet50_v2 --mode hybrid   --lr 0.1 --lr-mode cosine --num-epochs 120 --batch-size 32 -j 6   \
    --warmup-epochs 5 --use-rec --dtype float16 --optimizer nag \
    --trainer qsparselocalsgd --input-sparse-1 1 --output-sparse-1 4 --layer-sparse-1 32 --local-sgd-interval 8
    ...
    --model resnet50_v2 --mode hybrid   --lr 0.1 --lr-mode cosine --num-epochs 120 --batch-size 32 -j 6   \
    --warmup-epochs 5 --use-rec --dtype float16 --optimizer nag \
    --trainer partiallocalsgd --input-sparse-1 1 --output-sparse-1 4 --layer-sparse-1 4 --local-sgd-interval 16
    ...
    --model resnet50_v2 --mode hybrid   --lr 0.1 --lr-mode cosine --num-epochs 120 --batch-size 32 -j 6   \
    --warmup-epochs 5 --use-rec --dtype float16 --optimizer nag \
    --trainer partiallocalsgd --input-sparse-1 1 --output-sparse-1 4 --layer-sparse-1 8 --local-sgd-interval 32
