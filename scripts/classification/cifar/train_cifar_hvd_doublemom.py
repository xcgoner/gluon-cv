...
from gluoncv.trainer.doublemom_trainer import DoubleMomTrainer
...
def main():
    ...
    global_optimizer_params = {'learning_rate': opt.global_lr, 'wd': 0.0, 'momentum': opt.global_momentum}
    ...
    def train(epochs, ctx):
        ...
        trainer = DoubleMomTrainer(net.collect_params(),  
