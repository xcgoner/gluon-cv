...
def main():
    ...
    def train(epochs, ctx):
        ...
        for epoch in range(epochs):
            ...
            if rank == 0:
                logging.info('[Epoch %d] train=%f val=%f loss=%f comm=%.2f/%.2f lr=%.3f time: %f' %
                    (epoch, acc, val_acc, train_loss, trainer._comm_counter/1e6, trainer._comm_counter_full/1e6, trainer.learning_rate, toc-tic))
